...
def parse_args():
    ...
    parser.add_argument('--resume', default='/media/data/wq/deepcluster_exp/exp_pro2.0/checkpoint.pth.tar', type=str, metavar='PATH',
